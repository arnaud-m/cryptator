...
** Configure the algorithm
 ...
 #+BEGIN_SRC sh
   ...
   echo $ARGS -l FALSE --horner FALSE > algorithms/SCALAR.dat
   echo $ARGS -l FALSE --horner TRUE > algorithms/HORNER.dat

#   echo $ARGS -l TRUE -search 1 > algorithms/BIGNUM-1.dat
#   echo $ARGS -l FALSE --horner FALSE -search 1 > algorithms/SCALAR-1.dat
#   echo $ARGS -l FALSE --horner TRUE -search 1 > algorithms/HORNER-1.dat
 #+END_SRC
