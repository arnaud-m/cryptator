...
*** Crossword
 ...
 #+BEGIN_SRC sh
   ...
   (
       cd samples
       pwd
       ../../R/sample-words.R -n 60 -w 12 --minlen 2 --maxlen 3  ../../words/liste.de.mots.francais.frgut.txt
   )
 #+END_SRC
...
#+BEGIN_SRC R
  ...
  dbfiles <- list.files(c("../cryptarithms", "results-classified"), pattern = "*.db.txt", full.names=TRUE)
