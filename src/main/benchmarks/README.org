...
*** Addition
 #+BEGIN_SRC sh
   echo -v quiet -d FALSE -a BIGNUM > algorithms/ALL.dat
 #+END_SRC
...
** Configure the algorithm
 ...
 #+BEGIN_SRC sh
   ...
   echo $ARGS -a BIGNUM > algorithms/BIGNUM.dat
   echo $ARGS -a SCALAR  > algorithms/SCALAR.dat
   echo $ARGS --a SCALAR --horner > algorithms/HORNER.dat
 #+END_SRC
