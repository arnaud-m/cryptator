...
/**
 * The Interface ICryptaGameEngine defines a simple pedagogical game engine for
...
public interface ICryptaGameEngine {
     ...
     * @throws CryptaGameException if the game cannot be initialized. For instance,
     *                             the cryptarithm has no solution.
     */
     ...
     * @return true, if the decision was applied, and false if its refutation was
     *         applied.
     ...
     *
     * @return true, if the cryptarithm is solved, and false if some letters remain
     *         unknown.
     */
    boolean isSolved();
