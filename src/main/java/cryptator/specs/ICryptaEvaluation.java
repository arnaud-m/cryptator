...
/**
 * The Interface ICryptaEvaluation evaluates a cryptarithm for a given solution
 * and base.
 */
public interface ICryptaEvaluation {

    /**
     * Evaluate the value of a cryptarithm for a given solution and base. A
     * cryptarithm that contains relational operator returns a logical value, and a
     * numeric value otherwise. A logical value is false if equal to 0 and true
     * otherwise.
     *
     ...
     * @throws CryptaEvaluationException if the solution is partial (some symbols
     *                                   miss digits).
     */
