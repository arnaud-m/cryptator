...
public final class WordSumTuplesBuilder {
    ...
    public void setBase(final int base) {
        if (base > 1) {
            ...
            throw new IllegalArgumentException("The base must be greater than 2.");
        }
    }
    ...
    /**
     * Computes the exponentiation of x in base b : x * b^k. It fails if the
     * exponent is negative unless x is equal to 0.
     *
     * @param x the coefficient
    ...
    /**
     * Computes the maximum cardinality of numbers with strictly less than k-1
     * digits.
     *
     * @param values the cardinalities of numbers, i.e. the i-th value is the
