...
public class JsonTest {
	...
	public InputStream solve(String Cryptarithm) throws StreamReadException, DatabindException, IOException, CryptaModelException, CryptaSolverException {
		// Create config
	...
	@Test
	public void testSendMoreMoney() throws StreamReadException, DatabindException, IOException, CryptaModelException, CryptaSolverException {
		assertNotNull(solve("send+more=money"));     
	}

	@Test
	public void testBigCatLion() throws StreamReadException, DatabindException, IOException, CryptaModelException, CryptaSolverException {
