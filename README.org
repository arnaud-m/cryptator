...
*** Run the solver
 ...
 : java -cp target/cryptator-0.2.0-with-dependencies.jar cryptator.Cryptator -s 1 'send+more=money'

*** Play the game

 : java -cp target/cryptator-0.2.0-with-dependencies.jar cryptator.Cryptamancer 'send+more=money'
